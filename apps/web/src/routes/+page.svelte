      ...
      {:else if poseFrame}
        <div class="pose-visual">
          ...
          {#if pose.kind === 'hips-low' || pose.kind === 'hips-high'}
            <span class:high={pose.kind === 'hips-high'} class="body-region-highlight" aria-hidden="true"></span>
          {/if}
        </div>
      {/if}
    </section>
