...
| SvelteKit / adapter-auto | 2.70.1 / 4.0.0 | [SvelteKit](https://github.com/sveltejs/kit) contributors | MIT | Preserve upstream copyright and license notice | Web application/local build tooling | PASS |
| Vercel SvelteKit adapter | 6.3.4 | [SvelteKit](https://github.com/sveltejs/kit) contributors | MIT | Preserve upstream copyright and license notice | Vercel production packaging | PASS |
